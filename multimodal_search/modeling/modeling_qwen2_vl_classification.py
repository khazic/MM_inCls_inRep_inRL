...
from transformers.models.qwen2_vl.modeling_qwen2_vl import Qwen2VLPreTrainedModel, Qwen2VLModel, Qwen2VisionTransformerPretrainedModel, Qwen2VLCausalLMOutputWithPast

logger = logging.get_logger(__name__)

_CONFIG_FOR_DOC = "Qwen2VLConfig"

class Qwen2VLForClassification(Qwen2VLPreTrainedModel):
    ...
    def get_rope_index(
        ...
        Args:
            ...
            image_grid_thw: The temporal, height and width of feature shape of each image
            video_grid_thw: The temporal, height and width of feature shape of each video
